...
You can bind mount a shell script to `/home/vscode/.welcome.sh` to replace the [current welcome script](https://github.com/iznth/basedevcontainer/blob/master/shell/.welcome.sh).
